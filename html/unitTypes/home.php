		...
		<?php
			...
			foreach($unitTypeList as $unitType)
			{
				echo "<tr>";
					...
					{ echo "<td><button type=\"button\" class=\"editSmall\" onclick=\"document.location.href='updateUnitTypeForm.php?unitType={$unitType->getUnitType()}'\">Edit</button></td>"; }
				echo "
					<td>{$unitType->getUnitType()}</td>
