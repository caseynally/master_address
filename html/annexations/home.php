		...
		<?php
			...
			foreach($annexationList as $annexation)
			{
				echo "<tr>";
					...
					{ echo "<td><button type=\"button\" class=\"editSmall\" onclick=\"document.location.href='updateAnnexationForm.php?ordinanceNumber={$annexation->getOrdinanceNumber()}'\">Edit</button></td>"; }
				echo "
