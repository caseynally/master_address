<?php
/**
 * A collection class for Jurisdiction objects
 *
 ...
 */
class JurisdictionList extends ZendDbResultIterator
{
	/**
	...
	{
		return new Jurisdiction($this->result[$key]);
	}
}
