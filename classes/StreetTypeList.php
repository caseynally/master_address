...
class StreetTypeList extends ZendDbResultIterator
{
	 ...
	 */
	public function find($fields=null,$order='suffix_code',$limit=null,$groupBy=null)
	{
		$this->select->from('mast_street_type_suffix_master');

		// Finding on fields from the mast_street_type_suffix_master table is handled here
		if (count($fields)) {
		...
		// above foreach only handles fields from the mast_street_type_suffix_master table.
