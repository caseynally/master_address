 ...
 */
class StreetNameList extends ZendDbResultIterator
{
	/**
	...
	public function find($fields=null,$order='id',$limit=null,$groupBy=null)
	{
		...
		// above foreach only handles fields from the mast_street_names table.
	...
	/**
	 * Hydrates all the MastStreetName objects from a database result set
	 *
	 * This is a callback function, called from ZendDbResultIterator.  It is
	 * called once per row of the result.
	 *
	 * @param int $key The index of the result row to load
	 * @return MastStreetName
	 */
	protected function loadResult($key)
	{
		return new StreetName($this->result[$key]);
	}
}
