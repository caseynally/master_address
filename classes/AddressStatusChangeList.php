<?php
/**
 * A collection class for MastAddressStatus objects
 *
...
class AddressStatusChangeList extends ZendDbResultIterator
{
	...
	public function find($fields=null,$order='start_date desc',$limit=null,$groupBy=null)
	{
		...
		// above foreach only handles fields from the mast_address_status table.
	...
	/**
	 * Hydrates all the MastAddressStatus objects from a database result set
	 *
	 * This is a callback function, called from ZendDbResultIterator.  It is
	 * called once per row of the result.
	 *
	 * @param int $key The index of the result row to load
	 * @return MastAddressStatus
	 */
