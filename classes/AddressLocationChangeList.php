<?php
/**
 * A collection class for MastAddressLocationChange objects
 *
 ...
 * each MastAddressLocationChange object
 *
 ...
 */
class AddressLocationChangeList extends ZendDbResultIterator
{
	/**
	...
	public function find($fields=null,$order='location_change_id',$limit=null,$groupBy=null)
	{
		...
		// above foreach only handles fields from the mast_address_location_change table.
	...
	/**
	 * Hydrates all the MastAddressLocationChange objects from a database result set
	 *
	 * This is a callback function, called from ZendDbResultIterator.  It is
	 * called once per row of the result.
	 *
	 * @param int $key The index of the result row to load
	 * @return MastAddressLocationChange
	 */
	protected function loadResult($key)
	{
		return new AddressLocationChange($this->result[$key]);
	}
}
