<?php
/**
 * A collection class for BuildingsStatusLookup objects
 *
 ...
 * each BuildingsStatusLookup object
 *
...
class BuildingStatusList extends ZendDbResultIterator
{
	...
	public function find($fields=null,$order='status_code',$limit=null,$groupBy=null)
	{
		...
		// above foreach only handles fields from the buildings_status_lookup table.
	...
	/**
	 * Hydrates all the BuildingsStatusLookup objects from a database result set
	 *
	 * This is a callback function, called from ZendDbResultIterator.  It is
	 * called once per row of the result.
	 *
	 * @param int $key The index of the result row to load
	 * @return BuildingsStatusLookup
	 */
