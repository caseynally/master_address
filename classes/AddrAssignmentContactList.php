<?php
/**
 * A collection class for MastAddrAssignmentContact objects
 *
 ...
 * each MastAddrAssignmentContact object
 *
 ...
 */
class AddrAssignmentContactList extends ZendDbResultIterator
{
	/**
	...
	/**
	 * Hydrates all the MastAddrAssignmentContact objects from a database result set
	 *
	 * This is a callback function, called from ZendDbResultIterator.  It is
	 * called once per row of the result.
	 *
	 * @param int $key The index of the result row to load
	 * @return MastAddrAssignmentContact
	 */
	protected function loadResult($key)
	{
		return new AddrAssignmentContact($this->result[$key]);
	}
}
