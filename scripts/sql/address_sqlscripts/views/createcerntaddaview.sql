...
-- active registered rental addresses (ie. r.property_status = 'R' or 'V')
-- update to add Vacant Rentals with current permits since they could be rented anytime 
--     after the inspection if they have a valid permit)

create or replace view ce.rnt_adda as
select
	distinct
...
and (r.property_status = 'R' 
	or (r.property_status = 'V' and r.permit_expires is not NULL and r.permit_expires >= sysdate))
