...
use Application\Subunits\Subunit;
...
class Location extends ActiveRecord
{
    ...
    public function getAddress() { return parent::getForeignKeyObject('Application\Addresses\Address', 'address_id'); }
    public function getSubunit() { return parent::getForeignKeyObject('Application\Subunits\Subunit', 'subunit_id'); }

    public function setType_id   (int $id) { parent::setForeignKeyField (__namespace__.'\Type',                     'type_id', $id); }
    public function setAddress_id(int $id) { parent::setForeignKeyField ('Application\Addresses\Address', 'address_id', $id); }
    public function setSubunit_id(int $id) { parent::setForeignKeyField ('Application\Subunits\Subunit', 'subunit_id', $id); }
    public function setType      (Type $o) { parent::setForeignKeyObject(__namespace__.'\Type',                     'type_id',  $o); }
    public function setAddress(Address $o) { parent::setForeignKeyObject('Application\Addresses\Address', 'address_id',  $o); }
    public function setSubunit(Subunit $o) { parent::setForeignKeyObject('Application\Subunits\Subunit', 'subunit_id',  $o); }
